...
public class ExecuteCaseModel {
    ...
    public void execute(String browserName) {
        logger.info("开始执行测试用例 {}[point={}][tag={}][broswerType={}] ", name, point, tag, browserName);
        ...
        try {
            ...
            logger.info("测试用例 {}[point={}][tag={}][broswerType={}] ", name, point, tag, browserName);
        } catch (Exception e) {
            logger.error(e, "执行测试用例 {}[point={}][tag={}][broswerType={}] ", name, point, tag, browserName);
